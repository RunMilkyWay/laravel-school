...
Route::get('/seminar/create', [SeminarController::class, 'create'])->name('seminar.create')->middleware(['auth', WorkerMiddleware::class]);
Route::post('/seminar/store', [SeminarController::class, 'store'])->name('seminar.store')->middleware('auth');
Route::get('/seminar/{id}/edit', [SeminarController::class, 'edit'])->name('seminar.edit')->middleware(['auth', WorkerMiddleware::class]);
